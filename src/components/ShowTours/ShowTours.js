...
const ShowTours = ({ props, user, msgAlert, history }) => (
  <div>
    <Jumbotron fluid style={{ backgroundImage: 'url(https://www.smartertravel.com/wp-content/uploads/2017/08/grand-canyon-sunset-1200x627.jpg)', marginTop: '10px' }}>
      <Container>
        <Jumbotron fluid style={{ minWidth: '0', marginLeft: '500px', borderRadius: '13px', background: 'rgba(204, 204, 204, 0.3)', boxShadow: '4px 4px 4px 4px rgba(0, 0, 0, 0.1)' }}>
          <Container style={{ textAlign: 'center', color: 'white' }}>
            <h1><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
        ...
        <Jumbotron style={{ minWidth: '0', marginRight: '500px', borderRadius: '13px', background: 'rgba(65, 179, 163, 0.9)', boxShadow: '4px 4px 4px 4px rgba(0, 0, 0, 0.1)' }}>
          <Container style={{ textAlign: 'center', color: 'white' }}>
    ...
    <Jumbotron fluid style={{ background: 'rgba(226, 125, 96, 0.5)' }}>
      <Container>
        <Jumbotron fluid style={{ minWidth: '0', background: 'rgba(254, 255, 255, 0.5)', borderRadius: '13px', marginLeft: '200px', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)' }}>
          <Container style={{ textAlign: 'center', color: '#41B3A3', fontWeight: 'bold' }}>
            <h1>Let&apos;s face it</h1>
          </Container>
        </Jumbotron>
        <Jumbotron fluid style={{ minWidth: '0', background: 'rgba(254, 255, 255, 1)', borderRadius: '13px', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)' }}>
          <Container style={{ textAlign: 'center', color: '#FC4445' }}>
            <h1>traveling has changed.</h1>
          </Container>
        </Jumbotron>
        <Jumbotron fluid style={{ minWidth: '0', background: 'rgba(65, 179, 163, 0.9)', borderRadius: '13px', marginLeft: '200px', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)' }}>
          <Container style={{ textAlign: 'center', color: 'white' }}>
    ...
    <Jumbotron fluid style={{ minWidth: '0', backgroundImage: 'url(https://www.wallpapertip.com/wmimgs/50-501545_golden-gate-bridge.jpg)', backgroundPosition: 'center' }}>
      <Container style={{ textAlign: 'center' }}>
        <Form.Group variant="light" style={{ minWidth: '0', background: 'rgba(254, 255, 255, 0)', borderRadius: '6px', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)', border: 'none!important' }}>
    ...
    <Row style={{ marginTop: '30px' }}>
      <Jumbotron style={{ minWidth: '42%', backgroundColor: '#3FEEE6', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)' }}>
        <Container style={{ textAlign: 'center', color: '#E3E2DF' }}>
          <h4 style={{}}><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
