...
const ShowTours = ({ props, user, msgAlert, history }) => (
  <div>
    ...
    <Form.Group variant="light" style={{ minWidth: '0', borderRadius: '6px', background: 'rgba(65, 179, 163, 0.9)', boxShadow: '2px 2px 2px 2px rgba(0, 0, 0, 0.1)', border: 'none!important', marginTop: '10px' }}>
      <div>
    ...
    <Form.Group variant="light" style={{ minWidth: '0', backgroundColor: '#3FEEE6', boxShadow: '0px 2px 0px 0px rgba(0, 0, 0, 0.1)', border: 'none!important' }}>
      <div>
        <h4 style={{ color: '#E3E2DF' }}><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
